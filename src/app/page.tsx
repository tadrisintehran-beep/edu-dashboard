      ...
      <div style={{
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: '12px'}}>
          <div style={{textAlign: 'right'}}>
            <label style={{color: '#8b90a8', fontSize: '12px', display: 'block', marginBottom: '6px'}}>
              نام کاربری
            </label>
            <input
              type="text"
        ...
        <div style={{
          ...
          برای تست: نام کاربری <span style={{color: '#c9a84c'}}>admin</span> — رمز <span style={{color: '#c9a84c'}}>1234</span>
        </div>

        <p style={{color: '#555c78', fontSize: '11px', marginTop: '16px'}}>
