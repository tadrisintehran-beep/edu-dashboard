    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, #4a9eff11, transparent 70%)',
        }} />
        <div style={{
          position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)',
          width: '800px', height: '800px', borderRadius: '50%',
          background: 'radial-gradient(circle, #c9a84c05, transparent 60%)',
        }} />
      </div>
      ...
      >
        <div style={{ maxWidth: '400px', textAlign: 'center' }}>
          <div style={{
            ...
            borderRadius: '20px', padding: '4px', boxShadow: '0 4px 20px #00000033',
        ...
        <div style={{ width: '100%', maxWidth: '360px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            <div style={{
              ...
              background: '#ffffff', borderRadius: '16px', padding: '4px',
            ...
            <p style={{ color: '#555c78', fontSize: '13px' }}>
          ...
          {error && (
            <div style={{
              background: '#e0555522', border: '1px solid #e0555544',
              borderRadius: '10px', padding: '12px 14px',
              color: '#e05555', fontSize: '12px', marginBottom: '20px',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            {/* ایمیل */}
            <div>
              <label style={{ color: '#8b90a8', fontSize: '12px', display: 'block', marginBottom: '8px', fontWeight: '500' }}>
                ایمیل
              </label>
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{
                    width: '100%', background: '#131620',
                    border: '1px solid #ffffff0f', borderRadius: '10px',
                    padding: '12px 16px 12px 40px', color: '#e8eaf0',
                    fontSize: '13px', outline: 'none', direction: 'rtl',
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{
                    width: '100%', background: '#131620',
                    border: '1px solid #ffffff0f', borderRadius: '10px',
                    padding: '12px 16px 12px 80px', color: '#e8eaf0',
                    fontSize: '13px', outline: 'none', direction: 'rtl',
                    transition: 'border-color 0.2s', boxSizing: 'border-box',
                  }}
                  onFocus={e => (e.target as HTMLInputElement).style.borderColor = '#c9a84c55'}
                ...
                <button
                  ...
                  style={{ position: 'absolute', left: '36px', top: '50%', transform: 'translateY(-50%)', background: 'transparent', border: 'none', cursor: 'pointer', color: '#555c78', fontSize: '14px', padding: '4px' }}
                >{showPassword ? '🙈' : '👁'}</button>
              </div>
            </div>
            ...
            <button
              ...
              style={{
                ...
                background: isLoading ? '#a07830' : 'linear-gradient(135deg, #c9a84c, #e8c96a)',
                border: 'none', borderRadius: '10px', padding: '14px',
                color: '#1a1200', fontSize: '14px', fontWeight: '700',
                cursor: isLoading ? 'not-allowed' : 'pointer',
                fontFamily: 'inherit', transition: 'all 0.2s',
                boxShadow: isLoading ? 'none' : '0 4px 20px #c9a84c44',
              }}
              onMouseEnter={e => { if (!isLoading) (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(-1px)' }}
              onMouseLeave={e => { if (!isLoading) (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(0)' }}
            >
          ...
          <div style={{ textAlign: 'center', marginTop: '32px' }}>
            <div style={{ color: '#2a2e3d', fontSize: '11px', marginBottom: '8px' }}>
              ━━━━━━━━━━━━━━━━━━━━
            </div>
